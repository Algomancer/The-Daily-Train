...
class GPT(BaseModel):
    """The implementation is identical to `daily_train.model.GPT` with the exception that
...
class CausalSelfAttention(BaseCausalSelfAttention):
    """A modification of `daily_train.model.CausalSelfAttention` that adds the attention
